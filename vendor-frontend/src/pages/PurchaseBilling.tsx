              ...
              <div key={bill._id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex justify-between items-center animate-fade-in">
                ...
                <div className="text-right">
                  ...
                  <span className={`inline-block mt-2 text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-full ${
                    bill.paymentStatus === 'Paid' ? 'bg-green-50 text-green-700' : 'bg-amber-50 text-amber-700'
                  }`}>
                    {bill.paymentStatus}
                  </span>
                </div>
          ...
          <div className="bg-white w-full rounded-t-3xl max-h-[85vh] overflow-y-auto p-6 space-y-4 max-w-md mx-auto shadow-2xl">
            <div className="flex justify-between items-center border-b pb-3">
              <h2 className="text-lg font-bold text-gray-900 flex items-center">
                <ShoppingCart className="h-5 w-5 text-primary mr-1.5" /> Purchase Billing
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pb-8 text-left">
              ...
              <button
                type="submit"
                className="w-full bg-primary hover:bg-green-700 text-white font-bold py-3 px-4 rounded-xl shadow mt-4"
              >
                Save & Generate Purchase Bill
              </button>
            </form>
          </div>
        </div>
